...
function seedIfEmpty() {
  ...
  tasks = [
    ...
    { id: uid(), title: 'Reduzir consumo de energia', done: false, cat: 'Casa', due: '', prio: 'Alta', notes: '', sust: true },
    { id: uid(), title: 'Ir de bicicleta para a escola', done: false, cat: 'Transporte', due: '', prio: 'Baixa', notes: 'planejar deslocamentos a pé, de bicicleta ou transporte público, evitando uso excessivo do carro.', sust: true },
  ];
  save();
}
